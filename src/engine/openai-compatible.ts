...
export async function buildMessages(
  ...
  const systemContent = latest
    ? [
        ...
        'An earlier compaction summarised the older part of this',
        'session. Treat the following block as reliable context for',
        'every fact that is not explicitly repeated further below:',
        '',
        latest.summary,
        '</conversation-summary>',
      ].join('\n')
